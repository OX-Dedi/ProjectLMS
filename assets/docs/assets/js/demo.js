...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('Dedi:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('Dedi:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('Selamat Datang di "LMS", \nSelamat Belajar Berjuang untuk Masa Depan.!')
    }
  }, 1000)
